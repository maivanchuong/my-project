...
namespace benhxaCA.Report
{
    public partial class ReportViewer : System.Web.UI.Page
    {
        ...
        public void GenerateReportDocument(dynamic reportParam, string reportType, DataTable data)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/" + "Report//rpt//" + reportParam.RptFileName);
        ...
        public void ShowErrorMessage()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/" + "Report//rpt//blank.rdlc");
            ReportViewer1.DataBind();
            ReportViewer1.LocalReport.Refresh();
        }
    }
